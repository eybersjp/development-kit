...
> Status: Planned for Development Kit v0.7. This document defines target architecture and must not be read as shipped functionality until implementation and validation are complete.
