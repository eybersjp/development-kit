...
For the v0.10.1 release, the expected value is:
...
For v0.10.1, installer/distribution tests explicitly confirm the orchestration runtime and JSON schemas are present in isolated installed copies. Run `npm pack --dry-run` when the allowlist changes.
...
- [Release Notes v0.10.1](release-notes-v0.10.1.md)
