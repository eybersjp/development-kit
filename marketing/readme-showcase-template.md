...
The example below intentionally places spaces between Markdown link tokens so validation does not treat inactive asset paths as live links. Remove those spaces only after every asset has been captured, reviewed, and committed.
...
[ View the complete evidence walkthrough ] (marketing/product-showcase.md)
```
